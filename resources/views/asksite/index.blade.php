                    ...
                    <div class="item">
                        <div class="card horizontal">
                            <div class="card-image">
                                <img src="{{ asset('uploads/images/categories/' . $category->image) }}" alt="Image">
                            ...
                            <div class="card-stacked">
                                <div class="card-content">
                                    <a href="{{ route('category', $category->name) }}"
                                        class="tag left l-blue mb-10">{{ $category->name }}</a>
                                    <a href="{{ route('category', $category->name) }}" class="sm-name">وصف قصير عن القسم</a>
                                </div>
                                <!-- /.card-content -->
                            ...
                            <div class="card">
                                <div class="card-content w100dt">
                                    ...
                                    <ul class="post-mate right">
                                        ...
                                        <li class="comment">
                                            <a href="{{ route('single', $question->id) }}">
